...
public final class GeomantiaHttpServer {
    ...
    private static void start(MinecraftServer minecraftServer) {
        ...
        try {
            ...
            httpServer.createContext("/realm/city/upgrade_default_decoration_catalog", realmController::handleCityUpgradeDefaultDecorationCatalog);
            ...
            httpServer.createContext("/realm/city/query_template_metadata", realmController::handleCityQueryTemplateMetadata);
