...
public final class LandUseRuleCatalog {
    ...
    public static LandUseRuleCatalog defaults() {
        return new LandUseRuleCatalog(List.of(
                ...
                rule("military", List.of("military", "barracks", "guard_tower", "watch_post", "军事", "兵营", "哨所"),
                        1.5, 96, 96, 2048, 360, 1.0, 1.1, 1.1, 8.0, 0,
                        SurfacePolicy.PRESERVE, VegetationPolicy.SELECTIVE_CLEAR, BoundaryPolicy.LOW_WALL),
