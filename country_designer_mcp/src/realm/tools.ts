  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        wallVersion: {
          type: "string",
          enum: ["v4", "v3", "v2", "v1_debug"],
          description: "城墙 reservation 版本；默认 v2。v4 在 D5 仍生成 reservation/mask 上下文，D7 后按 actualFootprint land ring 生成墙图；v3 使用结构种子 patch region hull；v1_debug 使用旧矩形调试墙带。",
        },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        wallVersion: {
          type: "string",
          enum: ["v4", "v3", "v2", "v1_debug"],
          description: "城墙版本；默认 v2。v4 使用 actualFootprint land ring graph；v3 使用 structure-seeded patch region hull + road gate clusters。",
        },
        ...
        wallUnitLengthBlocks: { type: "number", description: "wallVersion=v4 的 graph unit 长度，默认 16，和 step 对齐。" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        debugScanStepBlocks: { type: "number", description: "debug scan 步长，默认 1。" },
        wallVersion: { type: "string", enum: ["v4", "v3", "v2", "v1_debug"], description: "D5/D7 城墙版本，默认 v3；测试 v4 时显式传 v4。" },
