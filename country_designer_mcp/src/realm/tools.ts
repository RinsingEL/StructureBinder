    ...
    inputSchema: {
      ...
      properties: {
        ...
        wallDesignPolicy: {
          type: "string",
          enum: ["v3", "v3.2"],
          description: "v3 城墙规划层设计策略；v3.2 启用天然边界、道路趋势开门、独立 gatehouse 和可用塔节点。",
        },
        minGateSpacingBlocks: { type: "number", description: "wallDesignPolicy=v3.2 城门最小间距，默认 48。" },
        minGateRoadLengthBlocks: { type: "number", description: "wallDesignPolicy=v3.2 道路趋势最小长度，默认 24。" },
        naturalWaterBoundaryMinAreaBlocks: { type: "number", description: "wallDesignPolicy=v3.2 大片水体天然边界最小 patch 面积，默认 4096。" },
